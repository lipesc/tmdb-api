Estudos backend API usando Spring webflux, swagger, e vue esse projeto é para consumir a API tmdb para procurar por filmes e listar o top 10 filmes do dia.
